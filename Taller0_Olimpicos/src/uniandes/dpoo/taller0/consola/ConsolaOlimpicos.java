...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Consultar país de un atleta (Nueva opción)");
		System.out.println("14. Salir de la aplicación\n");
	}
	
	/**
	 * Le muestra al ususario el país de un atleta
	 */
	...
	private void ejecutarPaisAtleta()
	{
		...
		String NombrePais= calculadora.PaisAtleta1(NombreAtleta);
		System.out.println("El atleta " + NombreAtleta + " pertene a: " + NombrePais);
	}
	/**
